...
function PizzaBlock({
    ...
    const onaAddPizza = () => {
        const obj = {
            ...
            imageUrl,
            price,
            //чекаем переданные данные в редакс
    ...
    return (
        <div className="pizza-block">
            ...
            <div className="pizza-block__bottom">
                ...
                <Button onClick={onaAddPizza} className="button--add" outline>
                    <svg
                        width="12"
                        height="12"
                        viewBox="0 0 12 12"
                    ...
                    >
                        <path
                            d="M10.8 4.8H7.2V1.2C7.2 0.5373 6.6627 0 6
                                            ...
                                            4.8 0 5.3373 0 6C0 6.6627 0.5373 7.2 1.2 7.2H4.8V10.8C4.8
                                            11.4627 5.3373 12 6 12C6.6627 12 7.2 11.4627 7.2 10.8V7.2H10.8C11.4627
